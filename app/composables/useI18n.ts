...
export const useI18n = () => {
  ...
  const translations: Record<string, Record<string, string>> = {
    en: {
      ...
      "editor.emailTrigger.description": "Configure your email provider to forward incoming emails to this endpoint. Email content becomes workflow input.",
      "editor.emailTrigger.endpointHint": "Configure your email provider's inbound webhook to POST to this URL.",
      "editor.emailTrigger.saveFirst": "Save workflow to generate your inbound email endpoint",
      "editor.emailTrigger.setupTitle": "Setup instructions",
      "editor.emailTrigger.step1": "Copy the endpoint URL above",
      "editor.emailTrigger.step2": "Go to your email provider's inbound settings",
      "editor.emailTrigger.step3": "Add webhook/forwarding URL pointing to this endpoint",
      "editor.emailTrigger.supportedProviders": "Supported providers",
      "editor.emailTrigger.dataFlowHint": "💡 Email data (from, subject, body, attachments) becomes 'input' for the next step. Access via input.from, input.subject, etc.",
    ...
    ru: {
      ...
      "editor.emailTrigger.description": "Настройте ваш email провайдер для пересылки входящих писем на этот endpoint. Содержимое письма становится входом workflow.",
      "editor.emailTrigger.endpointHint": "Настройте inbound webhook вашего email провайдера для POST запросов на этот URL.",
      "editor.emailTrigger.saveFirst": "Сохраните workflow для генерации endpoint входящей почты",
      "editor.emailTrigger.setupTitle": "Инструкция по настройке",
      "editor.emailTrigger.step1": "Скопируйте URL endpoint выше",
      "editor.emailTrigger.step2": "Перейдите в настройки inbound вашего email провайдера",
      "editor.emailTrigger.step3": "Добавьте webhook/forwarding URL, указывающий на этот endpoint",
      "editor.emailTrigger.supportedProviders": "Поддерживаемые провайдеры",
      "editor.emailTrigger.dataFlowHint": "💡 Данные письма (from, subject, body, attachments) становятся 'input' для следующего шага. Доступ через input.from, input.subject и т.д.",
