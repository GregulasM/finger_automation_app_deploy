      ...
      >
        ...
        >
          <div class="min-w-0 leading-tight">
            <div
              class="truncate text-[7px] 4xs:text-[8px] 3xs:text-[9px] 2xs:text-[10px] xs:text-[11px] sm:text-sm md:text-md lg:text-md 2xl:text-lg 3xl:text-lg/6 4xl:text-2xl/8 5xl:text-3xl/10 font-bold"
            >
              Finger Automation
            </div>
            <div
              class="truncate text-[5px] 4xs:text-[6px] 3xs:text-[7px] 2xs:text-[9px] xs:text-[10px] sm:text-[11px] md:text-xs lg:text-sm 2xl:text-base 3xl:text-lg/8 4xl:text-2xl/10 5xl:text-3xl/12 opacity-80"
            >
              Workflow studio
            </div>
          </div>
        ...
        <div class="flex items-center gap-1 4xs:gap-2">
          ...
          >
            <div class="hidden xs:block text-right leading-tight">
              ...
              <p
                class="text-[5px] 4xs:text-[6px] 3xs:text-[7px] 2xs:text-[9px] xs:text-[10px] sm:text-[11px] md:text-xs lg:text-sm 2xl:text-base 3xl:text-lg/8 4xl:text-2xl/10 5xl:text-3xl/12 opacity-75"
              >
                {{ user.email }}
              </p>
            </div>
